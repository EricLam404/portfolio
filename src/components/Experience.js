...
const Details = ({position, company, companyLink, time, address, work}) => {
    ...
    <li ref={ref} className='my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col items-center justify-between md:w-[80%]'>
        ...
        >
            <h3 className='capitalize font-bold text-2xl sm:text-2xl xs:text-lg'>{position}&nbsp;<a href={companyLink}
            target='_blank'
        ...
        <div ref={ref} className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
            ...
            <ul className='w-full flex flex-col items-start justify-between ml-4 xs:ml-4'>
                <Details 
                    ...
                    work="Software Engineer Intern @ Pulp"
                />
                <Details 
                    ...
                    time="July 2022"
                    address="New York City, New York"
                    work="Coding and Robotics Instructor @ Kwatt.io"
                />
            </ul>
        </div>
    </div>
