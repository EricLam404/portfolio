...
const NavBar = () => {
    ...
    return (
    <header className='w-full px-32 py-10 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8'>
        ...
        <div className='w-full flex justify-between items-center lg:hidden' >
            ...
            <nav className='flex items-center justify-center flex-wrap'>
                <motion.a href="https://github.com/EricLam404" target={"_blank"} 
                whileHover={{y: -2}} 
                whileTap={{scale: 0.9}}
                className='w-8 mx-3'
                >
                ...
                <motion.a href="https://www.linkedin.com/in/ericlam404/" target={"_blank"} 
                whileHover={{y: -2}} 
                whileTap={{scale: 0.9}}
                className='w-8 mx-3'
                >
            ...
            isOpen ?
                ...
                ' >
                    ...
                    <nav className='flex items-center justify-center flex-wrap mt-2'>
                        ...
                        whileHover={{y: -2}} 
                        whileTap={{scale: 0.9}}
                        className='w-8 mx-3 bg-light rounded-full dark:bg-dark'
                        >
                            <GithubIcon/>
                        </motion.a>
                        <motion.a href="/" target={"_blank"} 
